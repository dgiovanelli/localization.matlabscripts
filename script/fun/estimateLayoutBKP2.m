            ...
            for linkIdx = 1:noOfLinks
                if layoutNo ~= 0
                    ...
                    %if isfield(files{fileNo}.features,'Y')
                        linkLayoutAngleNode1 =  files{fileNo}.features.X.node1AngleOfLink{linkNo,1};
                ...
                linksAngleNode1Diff = [linksAngleNode1Diff, linkAngleNode1Diff];
                linksAngleNode2Diff = [linksAngleNode2Diff, linkAngleNode2Diff];
...
%                 end
            ...
            linksAngleNode1Updated = zeros(size(linksAngleNode1Diff));
            linksAngleNode2Updated = zeros(size(linksAngleNode2Diff));
...
%             linksAngleNode2Diff = (floor(linksAngleNode2Diff*1000000))/1000000; %use floor to avoid to overcome 2pi
            ...
            for nodeIdx = 1:size(availableIds,1)
                ...
                rotateNodeModelBy = alpha * sum([ linksAngleNode1Diff(:,linkIdxsN1),linksAngleNode2Diff(:,linkIdxsN2) ],2)./toAverage;
                
                for n = 1:size(linkIdxsN1,1)
                    linksAngleNode1Updated(:,linkIdxsN1(n)) = files{fileNo}.features.X.node1AngleOfLink{linkIdxsN1(n),1} + rotateNodeModelBy;
                    files{fileNo}.features.X.node1AngleOfLink{linkIdxsN1(n),1} = linksAngleNode1Updated(:,linkIdxsN1(n));
                end
                for n = 1:size(linkIdxsN2,1)
                    linksAngleNode2Updated(:,linkIdxsN2(n)) = files{fileNo}.features.X.node2AngleOfLink{linkIdxsN2(n),1} + rotateNodeModelBy;
                    files{fileNo}.features.X.node2AngleOfLink{linkIdxsN2(n),1} = linksAngleNode2Updated(:,linkIdxsN2(n));
                end
...
%                 files{fileNo}.features.X.node2AngleOfLink{linkIdx,1} = linkAngleNode2;
            ...
            linksAngleNode1Updated = double(mod(linksAngleNode1Updated,2*pi));
            linksAngleNode1Updated = (floor(linksAngleNode1Updated*1000000))/1000000; %use floor to avoid to overcome 2pi
            linksAngleNode2Updated = double(mod(linksAngleNode2Updated,2*pi));
            linksAngleNode2Updated = (floor(linksAngleNode2Updated*1000000))/1000000; %use floor to avoid to overcome 2pi
            
            X = [X ; rssi(trainingSetLogicalIdx), linksAngleNode1Updated(trainingSetLogicalIdx), linksAngleNode2Updated(trainingSetLogicalIdx)];
        end
    ...
    for fileNo = 1:noOfFiles
        ...
        for triangleIdx = 1:size(triangles,1)
            ...
            if isempty(link1_2idx)  %if it's empty the order of nodes is reversed, just search the correct link inverting the order
                ...
                link1_2AngleNode1Update = alpha*(link1_2LayoutAngleNode1 - files{fileNo}.features.X.node2AngleOfLink{link1_2idx,1});
                link1_2AngleNode2Update = alpha*(link1_2LayoutAngleNode2 - files{fileNo}.features.X.node1AngleOfLink{link1_2idx,1});
                
                link1_2AngleNode1 = files{fileNo}.features.X.node2AngleOfLink{link1_2idx,1} + link1_2AngleNode1Update;
                link1_2AngleNode2 = files{fileNo}.features.X.node1AngleOfLink{link1_2idx,1} + link1_2AngleNode2Update;
                ...
                link1_2AngleNode1Update = alpha*(link1_2LayoutAngleNode1 - files{fileNo}.features.X.node1AngleOfLink{link1_2idx,1});
                link1_2AngleNode2Update = alpha*(link1_2LayoutAngleNode2 - files{fileNo}.features.X.node2AngleOfLink{link1_2idx,1});
                
                link1_2AngleNode1 = files{fileNo}.features.X.node1AngleOfLink{link1_2idx,1} + link1_2AngleNode1Update;
                link1_2AngleNode2 = files{fileNo}.features.X.node2AngleOfLink{link1_2idx,1} + link1_2AngleNode2Update;
            ...
            if isempty(link2_3idx)  %if it's empty the order of nodes is reversed, just search the correct link inverting the order
                ...
                link2_3AngleNode1Update = alpha*(link2_3LayoutAngleNode1 - files{fileNo}.features.X.node2AngleOfLink{link2_3idx,1});
                link2_3AngleNode2Update = alpha*(link2_3LayoutAngleNode2 - files{fileNo}.features.X.node1AngleOfLink{link2_3idx,1});
                
                link2_3AngleNode1 = files{fileNo}.features.X.node2AngleOfLink{link2_3idx,1} + link2_3AngleNode1Update;
                link2_3AngleNode2 = files{fileNo}.features.X.node1AngleOfLink{link2_3idx,1} + link2_3AngleNode2Update;
                ...
                link2_3AngleNode1Update = alpha*(link2_3LayoutAngleNode1 - files{fileNo}.features.X.node1AngleOfLink{link2_3idx,1});
                link2_3AngleNode2Update = alpha*(link2_3LayoutAngleNode2 - files{fileNo}.features.X.node2AngleOfLink{link2_3idx,1});
                
                link2_3AngleNode1 = files{fileNo}.features.X.node1AngleOfLink{link2_3idx,1} + link2_3AngleNode1Update;
                link2_3AngleNode2 = files{fileNo}.features.X.node2AngleOfLink{link2_3idx,1} + link2_3AngleNode2Update;
            ...
            if isempty(link3_1idx)  %if it's empty the order of nodes is reversed, just search the correct link inverting the order
                ...
                link3_1AngleNode1Update = alpha*(link3_1LayoutAngleNode1 - files{fileNo}.features.X.node2AngleOfLink{link3_1idx,1});
                link3_1AngleNode2Update = alpha*(link3_1LayoutAngleNode2 - files{fileNo}.features.X.node1AngleOfLink{link3_1idx,1});
                
                link3_1AngleNode1 = files{fileNo}.features.X.node2AngleOfLink{link3_1idx,1} + link3_1AngleNode1Update;
                link3_1AngleNode2 = files{fileNo}.features.X.node1AngleOfLink{link3_1idx,1} + link3_1AngleNode2Update;
                ...
                link3_1AngleNode1Update = alpha*(link3_1LayoutAngleNode1 - files{fileNo}.features.X.node1AngleOfLink{link3_1idx,1});
                link3_1AngleNode2Update = alpha*(link3_1LayoutAngleNode2 - files{fileNo}.features.X.node2AngleOfLink{link3_1idx,1});
                
                link3_1AngleNode1 = files{fileNo}.features.X.node1AngleOfLink{link3_1idx,1} + link3_1AngleNode1Update;
                link3_1AngleNode2 = files{fileNo}.features.X.node2AngleOfLink{link3_1idx,1} + link3_1AngleNode2Update;
            ...
            if (strcmp(setSelectionStr,'Train') && (files{fileNo}.features.set{link1_2idx}(1) == options.TRAIN_SET_LABEL_CONSTANT) && (files{fileNo}.features.set{link2_3idx}(1) == options.TRAIN_SET_LABEL_CONSTANT)  && (files{fileNo}.features.set{link3_1idx}(1) == options.TRAIN_SET_LABEL_CONSTANT)) || ...
                ...
                %
                %                 disp([node1ID, node2ID, node3ID]);
                %                 disp(linksAnglesFeature(1,:)*options.RAD_TO_DEF_CONST);
